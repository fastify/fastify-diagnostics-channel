...
This event is sent when some error is throw on the [lifecycle](https://www.fastify.dev/docs/latest/Lifecycle/) of Fastify.
...
This event is sent when a request spent more time than [`connectionTimeout`](https://www.fastify.dev/docs/latest/Server/#connectiontimeout) specifies. For further information about `connectionTimeout` check the Fastify documentation.
